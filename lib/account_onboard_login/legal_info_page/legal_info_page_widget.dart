                          ...
                          Builder(
                            builder: (context) {
                              if (_model.psvSelectedChip == 'Privacy Policy') {
                                return MarkdownBody(
                                  data: '''---
Amit Vidyasagar built the Summify app as an ad-supported app. This SERVICE is provided by Amit Vidyasagar at no cost and is intended for use as is.
...
For a better experience, while using our Service, I may require you to provide us with certain personally identifiable information, including but not limited to Email, first name, last name, avatar photo. The information that I request will be retained on your device and is not collected by me in any way.
...
These Services do not address anyone under the age of 13. I do not knowingly collect personally identifiable information from children under 13 years of age. In the case I discover that a child under 13 has provided me with personal information, I intend to immediately delete this from our servers. If you are a parent or guardian and you are aware that your child has provided us with personal information, please contact me so that I will be able to do the necessary actions.
...
If you have any questions, suggestions about Privacy Policy, or need support for my App, do not hesitate to contact me at arv.dev.flostate@gmail.com.
''',
                                  selectable: true,
...
The Summify app stores and processes personal data that you have provided to us, to provide my Service. It’s your responsibility to keep your phone and access to the app secure. We therefore recommend that you do not jailbreak or root your phone, which is the process of removing software restrictions and limitations imposed by the official operating system of your device. It could make your phone vulnerable to malware/viruses/malicious programs, compromise your phone’s security features and it could mean that the Summify app won’t work properly or at all.
...
If you have any questions, suggestions about Terms & Conditions, or need support for my App, do not hesitate to contact me at arv.dev.flostate@gmail.com.
''',
                                  selectable: true,
                                  onTapLink: (_, url, __) => launchURL(url!),
                                );
